...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/InstantTemperature")
public class WebControllerInstantTemperature {
    private static final Logger LOGGER = Logger.getAnonymousLogger();
    private final ServiceInstantTemperature serviceInstantTemperature;
    private final ValueWSMapper valueWSMapper;

    public WebControllerInstantTemperature
        (ServiceInstantTemperature serviceInstantTemperature, ValueWSMapper valueWSMapper) {
        this.serviceInstantTemperature = serviceInstantTemperature;
        this.valueWSMapper = valueWSMapper;
    }

    @GetMapping("")
    public ResponseEntity<ValueWSDto> getInstantTemperature
    ...
    private static ValueWSDto linkBuilder(ValueWSDto valueWSDto) {
        final Link linkInstantTemperature
            = linkTo(WebControllerInstantTemperature.class).withSelfRel();
